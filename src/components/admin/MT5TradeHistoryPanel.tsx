...
export function MT5TradeHistoryPanel() {
  ...
  // Edit dialog state
  const [editTrade, setEditTrade] = useState<MT5TradeHistory | null>(null)
  ...
  const handleDelete = async (tradeId: string) => {
    ...
    try {
      await deleteTradeHistory(tradeId)
  ...
  const handleEdit = (trade: MT5TradeHistory) => {
    setEditTrade(trade)
